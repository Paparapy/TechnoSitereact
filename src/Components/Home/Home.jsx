...
const Home = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="flex items-center justify-center min-h-screen pt-20 sm:flex-col-reverse lg:pt-0 bg-gradient-to-r from-blue-800 via-gray-100 to-pink-600 animate-up"
    >
      <div className="container flex flex-col items-center justify-between mx-auto lg:flex-row sm:pb-5">
        <div className="px-4 lg:text-left sm:text-center lg:w-1/2">
          ...
          <p className="pb-5 mb-4 sm:text-[12px] lg:text-[15px] sm:text-center lg:text-justify text-gray-800 animate-paragraph animate-delay-2">
          ...
          <div className="animate-button animate-delay-1">
            <Link to="/technology">
              <button className="px-4 py-2 pb-3 sm:text-[12px] font-semibold text-white transition-all duration-300 bg-blue-500 rounded-full sm:px-2 sm:py-1 hover:bg-blue-600 animated-button">
                Découvrez plus
              </button>
            </Link>
          </div>
        ...
        <div className="relative px-4 pt-5 lg:w-1/2 sm:h-64 animate-background animate-delay-1">
          <img
            ...
            alt="Background"
            className="object-cover rounded-lg relative z-10 hover:shrink-animation lg:w-[450px] sm:w-[300px]"
          />
        </div>
      </div>
    </div>
