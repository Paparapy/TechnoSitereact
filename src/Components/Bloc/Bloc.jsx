  ...
  const blocs = [
    {
      ...
      imageUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSW7Nh45ddPmQ6knb3Moef7lqyTXL510swoRg&s",
    },
    {
      id: 2,
      ...
      imageUrl: "https://www.telecomreviewafrica.com/images/stories/2017/09/news-28-09-06.jpg",
    },
    {
      id: 3,
      title: "Intelligence artificielle",
      description: "Explorez le monde de l'IA et de l'apprentissage automatique.",
      ...
      imageUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT3Q08mrlcyblBRYwzkFGWYpf101LvbH88G4A&s",
    },
    {
      id: 4,
      ...
      imageUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRddipuE0WNr_pWG6wILB-UwGtoOywesII19w&s",
    },
    {
      id: 5,
      ...
      imageUrl: "https://image.lecourrier.vn/uploaded/2022/7/11/154452593ts.jpg",
    },
    {
      id: 6,
      title: "Cybersécurité",
      description: "Protégez vos données avec les dernières avancées en cybersécurité.",
      ...
      imageUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSwvKaXljrpLILmaOAZ-doznPvqYW2nyaC7Tg&s",
    },
    {
      id: 7,
      ...
      imageUrl: "https://images.bfmtv.com/n1tCVqMkUYxKFl0WS5KXzN9ZnIA=/1x11:849x488/848x0/images/Nouvelles-technologies-transformation-digitale-Quelles-opportunites-pour-les-investisseurs-1481489.jpg",
    },
    {
      id: 8,
      ...
      imageUrl: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQjncErd2RPwxbzAV0Iys2soGxu4lzkxtCJCg&s",
    },
  ];

  return (
    <div ref={containerRef} className="container min-h-screen py-16 mx-auto animate-up">
      <div className="grid min-h-screen grid-cols-1 gap-8 p-4 border-2 border-blue-200 rounded-lg md:grid-cols-2 sm:grid-cols-2 lg:grid-cols-4">
        {blocs.map((bloc) => (
          <div key={bloc.id} className="p-6 rounded-lg shadow-lg bg-gradient-to-t from-gray-600 via-gray-300 to-gray-400 shadow-gray-500">
            <h3 className="mb-2 text-[18px] font-semibold text-pink-800">{bloc.title}</h3>
            <div className="border-2 border-gray-200 rounded-lg img-container">
              <img
                src={bloc.imageUrl}
                alt={`Image for ${bloc.title}`}
                className="object-cover sm:w-[300px] sm:h-[200px] lg:w-full lg:h-[200px] p-2 rounded-xl"
              />
            </div>
            <p className="py-4 font-semibold text-center text-gray-700">{bloc.description}</p>
            <p className="text-pink-100">{bloc.text}</p>
          </div>
        ))}
      </div>
    </div>
